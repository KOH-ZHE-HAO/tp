...
public class TypicalPersons {
    ...
    // Manually added
    public static final Person HOON = new PersonBuilder().withRemark("abcd").withName("Hoon Meier").withPhone("8482424")
            .withEmail("stefan@example.com").withAddress("little india").build();
    public static final Person IDA = new PersonBuilder().withRemark("abcd").withName("Ida Mueller").withPhone("8482131")
